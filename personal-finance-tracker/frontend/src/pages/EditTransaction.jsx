  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const txRes = await apiClient.get(`/api/transactions/${id}`);
        const tx = txRes.data;
  ...
  return (
    <div className="space-y-6 max-w-xl mx-auto">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-white">Edit Transaction</h1>
          <p className="text-slate-400 text-xs">Modify the recorded transaction details.</p>
        </div>
      </div>
